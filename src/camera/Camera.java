...
//            SpriteBatch.draw(g, layers.get(i), this, imageScaler, imageController);
    ...
    public void onResolutionChange(int size, ArrayList<Layer> layers, ImageScaler scaler, ImageController imageController) {
...
//                    scaler.scaleAnimations(this, size, layer, imageController);
