...
public class FoodMap {
    ...
    public void createMap(float ar, float secondsDiff, int maxDiffX, int objectsAmount){
        ...
        for (int i = 0; i < objectsAmount; i++){
            ...
            coordinates.x += (int) (playerSpeed * boosted * distanceValue * dir * FPS_PER_SECOND / 2);
...
//                System.out.println("So before changes x: " + coordinates.x);
                coordinates.x -= (int) (playerSpeed * boosted * distanceValue * dir * FPS_PER_SECOND);
//                System.out.println("So after changes x: " + coordinates.x);
            }
            coordinates.y -= (int) ((startSpeed + (ar * perArSpeed)) * (secondsDiff * FPS_PER_SECOND) * distanceValue);
